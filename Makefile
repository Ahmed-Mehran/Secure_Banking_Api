# this Makefile mainly to provide short, easy-to-remember shortcuts for common Docker and Django commands, so you don’t have to type long docker compose commands again and again.
